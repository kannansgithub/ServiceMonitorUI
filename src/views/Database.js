...
class Databases extends React.Component {
  LoadServerData = () => {
    this.props.LoadServices(this.props.currentEnvironmentId, 'Database');
  }
  componentDidMount() {
    this.LoadServerData();
  }
  constructor(props) {
    super(props);
    this.state = {
      backgroundImage: require("../images/content-management/database.png"),
    };
  }
...
export default connect(mapStateToProps, { LoadServices })(Databases);
