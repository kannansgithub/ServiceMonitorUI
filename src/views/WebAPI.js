...
class WebAPI extends React.Component {
  LoadServerData = () => {
    this.props.LoadServices(this.props.currentEnvironmentId, 'Web API');
  }
  componentDidMount() {
    this.LoadServerData();
  }
  constructor(props) {
    super(props);
    this.state = {
      backgroundImage: require("../images/content-management/webapi.png"),
    };
  }
...
export default connect(mapStateToProps, { LoadServices })(WebAPI);
